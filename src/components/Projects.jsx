...
const Projects = ({ onSpotClick, onCobotClick }) => {
  ...
  const gridItems = [
    ...
    },
    {
      ...
      gridSpan: "col-span-1 row-span-1",
      mobileSpan: "col-span-1 row-span-1",
      link: "/portfolio/spot-head"
    },
    {
      type: "project",
      title: "Texas Aerial Robotics Thrust Vector Drone System",
      subtitle: "TAR • Controls • Simulink",
      description: "Designed and implemented thrust-vector control architecture in Simulink for precise multirotor trajectory tracking.",
      image: "/images/Landing Page Graphics/tar_dart_drone.png",
      bgColor: "bg-indigo-100",
      gridSpan: "col-span-1 row-span-1",
      mobileSpan: "col-span-1 row-span-1",
      link: "/portfolio/thrustvector"
    },
    {
      type: "project",
    ...
    },
    {
      ...
      description: "Built a Unity-based VR environment simulating pod dynamics and control systems for interactive testing and visualization.",
    ...
    },
    {
      ...
      description: "Developed a Vertex AI-driven content recommendation platform that transforms influencer descriptions into polished campaign captions and hashtags.",
    ...
    },
    {
      ...
      description: "Created biodegradable 3D-printed planters featuring AI-generated textures and forms exploring the blend of art and sustainability.",
      image: "/images/Landing Page Graphics/pictureplots_planter.png",
      bgColor: "bg-lime-100",
      gridSpan: "col-span-1 row-span-1",
      mobileSpan: "col-span-1 row-span-1",
      link: "/portfolio/picture-plots"
    }
  ];
              ...
              <motion.div
                ...
                onClick={item.type === "project" && item.link ? () => {
                  if (item.link === "/portfolio/spot" && onSpotClick) {
                    ...
                    onCobotClick();
                  } else if (item.link === "/portfolio/spot-head") {
                    window.location.href = item.link;
                  } else {
                    window.location.href = item.link;
                  }
