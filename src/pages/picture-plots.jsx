        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
          ...
          >
            ...
            >
              <div className="max-w-2xl">
                ...
                <h2 className="font-playfair text-2xl md:text-3xl lg:text-4xl font-semibold mb-6 text-pictureplots-accent">
                ...
                <motion.button
                  ...
                  className="inline-flex items-center px-8 py-4 bg-pictureplots-accent hover:bg-pictureplots-accent200 text-gray-900 font-semibold rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-gray-600 leading-relaxed font-inter">
              Each planter design was developed to highlight visual balance, surface texture, and proportion. The hero planter captures a calm organic aesthetic, while the geometric form represents modern minimalism in concrete and sandstone.
            </p>
          </motion.section>
          ...
          >
            ...
            <div className="flex justify-center">
              <div className="flex space-x-2">
                <div className="w-2 h-2 bg-pictureplots-accent rounded-full"></div>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="font-inter text-lg text-pictureplots-accent">What we explored</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                "Explored geometric precision and natural curvature.",
                "Balanced minimalism and organic form.",
                "Used consistent HDRI lighting for realism.",
                "Demonstrated clean topology and material variation."
              ].map((highlight, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <div className="w-3 h-3 rounded-full bg-pictureplots-accent mt-2 flex-shrink-0"></div>
          ...
          >
            <div className="bg-white rounded-4xl p-8 md:p-12 shadow-soft">
              ...
              <p className="font-inter text-lg text-gray-600 mb-8 max-w-3xl mx-auto">
                Continue developing hybrid organic-geometric designs and experiment with procedural texturing and advanced material nodes for realistic visual storytelling.
              </p>
              <motion.button
                onClick={() => window.location.href = "mailto:kashfsiddiqui@utexas.edu"}
                className="bg-pictureplots-accent hover:bg-pictureplots-accent200 text-gray-900 font-medium px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 shadow-lg"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Contact me
...
export default PicturePlotsPage;
